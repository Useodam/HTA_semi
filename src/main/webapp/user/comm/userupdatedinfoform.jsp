...
<div class="container">
	<div class="row">
		<div class="offset-3 col-6">
			<h1 class="text-center my-3">회원정보수정</h1>
<%
...
%>			
			...
			<form class="row border bg-white p-3 g-2" method="post" action="userupdatedinfo.jsp">
				<div class="form-group mb-3">
					<label for="id">아이디</label>
					<input type="text" id="id" class="form-control" name="id" placeholder="<%=savedUser.getId()%>" disabled/>
				</div>
               	<div class="form-group mb-3">
               		<label for="name">이름</label>
                  	<input type="text" id="name" class="form-control" name="name" placeholder="<%=savedUser.getName()%>" disabled/>
               	</div>
               	<div class="form-group mb-3">
                  	<label for="pwd">비밀번호</label>
                  	<input type="password" id="pwd" class="form-control" name="pwd" placeholder="비밀번호" onkeyup="checkPassword()"/>
				...
				<div class="btn-gruop form-group text-end">
                 	...
                 	<a href="userinfoform.jsp" class="btn btn-secondary">돌아가기</a>
              	</div>
         </form>
      </div>
   </div>
...
<script>
	function checkPassword() {
		...
		// 비밀번호는 영어대/소문자, 숫자, 특수문자를 사용하여 6글자 이상 사용하게 하는 정규 표현식
