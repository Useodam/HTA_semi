...
%>
								...
								<tr>
									...
									<td>
										<select name="service" class="border">
											<option value="" selected>선택하세요</option>
											<option value="1" <%="1".equals(opt) ? "selected" : "" %>>가정이사</option>
											<option value="2" <%="2".equals(opt) ? "selected" : "" %>>국내이사</option>
											<option value="3" <%="3".equals(opt) ? "selected" : "" %>>원룸/소형이사</option>
											<option value="4" <%="4".equals(opt) ? "selected" : "" %>>사무실이사</option>
										</select>
									</td>
								</tr>
							</tbody>
				...
				<div class="">
					총 판매자수 : <strong class=""><%=sellerList.size() %></strong>명
				</div>
				<div class="">
				...
				<div class="">
					<table class="table table-bordered">
						...
						<thead class="table-light">
							<tr>
								<th scope="col">번호</th>
								<th scope="col"><a href="">회원명</a></th>
								<th scope="col"><a href="">아이디</a></th>
								<th scope="col">서비스 유형</th>
								<th scope="col">핸드폰</th>
								<th scope="col"><a href="">가입일시</a></th>
